...
<<<<<<< HEAD
    ...
    semesters.forEach(semester => {
      ...
      if (year === 'Extras') {
        // For Extras, directly scan the category folder
        scanDirectoryRecursive(semesterPath, year, semester);
      } else {
        // For FE/SE/TE/BE, get subject folders
        ...
        subjects.forEach(subject => {
          ...
          if (fs.statSync(subjectPath).isDirectory()) {
            scanDirectoryRecursive(subjectPath, year, subject);
          }
        });
      }
=======
